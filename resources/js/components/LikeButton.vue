...
export default{
    data(){
        return{
            like:false,
            userIdArray: [],
            likepeopledata:this.likepeople
        }
    },
    props:['post','loginuser','likepeople'],
    methods:{
        likeCliked(){
        ...
        checkLikes(){
            // this.post.likes가 현재 로그인한 사용자의 아이디 즉, this.loginuser를 포함하고 있으면 like = true, 그렇지 않으면 like=false
